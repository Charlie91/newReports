...
var CalendarDay = function (_BaseClass) {
  _inherits(CalendarDay, _BaseClass);
...
exports['default'] = (0, _reactWithStyles.withStyles)(function (_ref2) {
  ...
  return {
    ...
    CalendarDay__selected_span: {
      ...
      border: '1px double ' + String(color.selectedSpan.borderColor),
    ...
    CalendarDay__selected: {
      ...
      border: '1px double ' + String(color.selected.borderColor),
    ...
    CalendarDay__hovered_span: {
      ...
      border: '1px double ' + String(color.hoveredSpan.borderColor),
...
}, { pureComponent: _baseClass.pureComponentAvailable })(CalendarDay);